<template>
    <div class="flex justify-center items-start h-screen pt-8">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-7xl">
            <h2 class="text-center text-2xl font-bold mb-8">Formulario de Admisión</h2>
            <div class="flex items-center justify-between mb-4">
                ...
                <button class="bg-blue-500 hover:bg-blue-600 text-white fontbold py-2 px-4 rounded" @click="agregarPrisionero">
                    Agregar
                </button>
            </div>
...
export default {
    ...
    methods: {
        ...
        agregarPrisionero() {
            this.$router.push("/newPrisionero")
        },
    },
}
</script>
